...
import type {FileToAutogenerate} from "#~src/internal/InternalSessionState.ts"
import path from "node:path"
import {writeAtomicFile, isFileSync} from "@anio-software/pkg.node-fs"
import {createHash} from "node:crypto"
import {isAutogeneratedFile} from "#~src/internal/autogenerate/isAutogeneratedFile.ts"
import {getAutogeneratedFileHeader} from "#~src/internal/autogenerate/getAutogeneratedFileHeader.ts"
